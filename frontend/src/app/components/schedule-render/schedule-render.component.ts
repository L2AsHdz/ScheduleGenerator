...
@Component({
  selector: 'app-schedule-render',
  templateUrl: './schedule-render.component.html',
  styleUrls: ['./schedule-render.component.css']
})
export class ScheduleRenderComponent implements OnInit {
